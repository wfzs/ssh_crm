							...
							<TBODY>
								<TR>
									<TD height=25>	
										...
										action="${pageContext.request.contextPath }/SavleVisitAction_list"
										method=post>
										<!-- 隐藏域.当前页码 -->
										...
										<TABLE id=grid
											...
											<TBODY>
												...
												<TR
													...
													<TD>
															<!-- 没有传递参数,显示删除和修改操作 -->
														<a href="${pageContext.request.contextPath }/SavleVisitAction_toEdit?visit_id=<s:property value="visit_id" />">修改</a>
														&nbsp;&nbsp;
